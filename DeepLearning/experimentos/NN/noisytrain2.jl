...
BSON.@load "model1.bson" cpu_model  # load the model from BSON file
...
BSON.@save "data_n2.bson" x_data1 y_data1  # save the data for later use
...
BSON.@save "model_n2.bson" cpu_model  # save the trained model
